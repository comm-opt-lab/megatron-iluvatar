...
def _add_distributed_args(parser):
    ...
    group.add_argument('--dgc-enabled', action='store_true', default=False,
                       help='Enable DGC top-k sparse gradient synchronization.',
                       dest='dgc_enabled')
    group.add_argument('--dgc-density', type=float, default=1.0,
                       help='Fraction of gradient elements retained by DGC.',
                       dest='dgc_density')
    group.add_argument('--dgc-momentum', type=float, default=0.9,
                       help='DGC momentum correction factor.', dest='dgc_momentum')
    group.add_argument('--dgc-min-numel-to-compress', type=int, default=16384,
                       help='Minimum bucket size compressed by DGC.',
                       dest='dgc_min_numel_to_compress')
    group.add_argument('--dgc-impl', choices=('torch', 'corex'), default='torch',
                       help='Local DGC compression implementation.', dest='dgc_impl')
