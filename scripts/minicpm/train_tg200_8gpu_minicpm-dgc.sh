...
# 原 ts-tg200：/home/yaowenxuan/ff/tg200/ixmegatron-speedup
readonly MEGATRON_PATH="${MEGATRON_PATH:-${REPO_ROOT}/Megatron-LM-dgc}"
...
readonly RUN_DIR="${WORK_DIR}/runs/${RUN_ID}-dgc-density${DGC_DENSITY}"
...
echo "DGC: density=${DGC_DENSITY}, momentum=${DGC_MOMENTUM}, min_numel=${DGC_MIN_NUMEL}"
